//
//  hotArticleTableViewController.swift
//  GitLab_CL
//
...
class hotArticleTableViewController: UITableViewController {
    var articleNames = ["","",""]
    var articleImages = ["文章banner秋裝","穿搭教學簡單_工作區域 1","今日"]
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.thumbnailImageView.image = UIImage(named: articleImages[indexPath.row])
